...
<form action="{{ route( 'akun.update' , $akun->id ) }}" method="POST" enctype="multipart/form-data">
    ...
    <form action="{{ route('updatePassword', $akun->id ) }}" method="POST" enctype="miltipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="col-md-6">
            <input type="password" class="form-control" id="password_confirmatioon" name="password_confirmation">
        </div>
        <br><br>
